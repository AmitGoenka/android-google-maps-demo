...
import static com.example.mapdemo.utils.MapUtils.addMarker;
import static com.example.mapdemo.utils.MapUtils.createBubble;
import static com.example.mapdemo.utils.MapUtils.dropPinEffect;
...
public class MapDemoActivity extends AppCompatActivity implements
    ...
    private final String CHANNEL_NAME = "android-2016";
    ...
    */
    ...
    private void showAlertDialogForPoint(final LatLng latLng) {
        ...
        alertDialog.setButton(DialogInterface.BUTTON_POSITIVE, "OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                BitmapDescriptor icon = createBubble(MapDemoActivity.this, IconGenerator.STYLE_GREEN, title);
                Marker marker = addMarker(map, latLng, title, snippet, icon);
    ...
    public void onMarkerUpdate(PushRequest pushRequest) {
        Toast.makeText(this, "OnMarkerUpdate Called:", Toast.LENGTH_LONG).show();
        pushUtil.handleMarkerUpdates(this, pushRequest, map);
